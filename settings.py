...
HUMAN_FEMALE_SEX_MAX_AGE = 50 * DAYS_IN_YEAR  # max age females can give birth
HUMAN_MALE_SEX_MAX_AGE = 80 * DAYS_IN_YEAR  # max age males can procreate

WORLD_INIT_AGE = 0
WORLD_MAX_AGE = 16 * DAYS_IN_YEAR  # days before the world ends
WORLD_SIZE = 256  # world size in square points i.e. 32x32
